if (plr.getQuestStatus(2048) != 1) {
    ...
    npc.sendBackNext("Hmmm... so you want to know how to get #bPiece of Ice#k, #bAncient Scroll#k, and #bFlaming Feather#k? What do you plan on doing with those precious materials? I've heard about those, since I studied the island a bit before doing my work now as a guard...", false, true)
