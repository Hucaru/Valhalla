// Check distance
if (plr.getPosition().y > -1038) {
    npc.sendOk("You're too far from Neru. Get closer.")
    return
}

// Check for letter
if (plr.itemQuantity(4031128) < 1) {
...
// Check pet and letter
if (plr.itemQuantity(4031128) > 0 && plr.getPet(0) != null) {
    plr.takeItem(4031128, 1)
    var closenessValues = [1, 2, 3, 4, 5, 6, 7, 8, 9]
    var randomCloseness = closenessValues[Math.floor(Math.random() * closenessValues.length)]
    plr.givePetCloseness(randomCloseness)
