if (plr.level() < 50) {
    ...
    npc.sendBackNext("You're no thief. I am not qualified to judge you. If you want to explore Zakum, you will need to find a master of your job class to be your guide.", true, false)
} else {
    ...
    npc.sendBackNext("Then I will send you to #bThe Door to Zakum#k, where #b#p2030008##k is.", true, false)
    plr.warp(211042300)
}
