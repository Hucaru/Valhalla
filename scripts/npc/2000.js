...
var qd = plr.questData(Quest_Roger_Apple)
var started = (qd === "1")
var completed = (qd === "end")

if (completed) {
    npc.sendOk("We've already done that lesson. Take good care of yourself out there!")
} else if (sel != 0) {
    npc.sendOk("Let me know if you need anything.")
} else if (started && plr.itemCount(2010000) >= 1) {
    npc.sendOk("You haven't eaten the #bApple#k that I gave you yet. Talk to me once you have!")
} else if (started && plr.itemCount(2010000) == 0) {
