...
} else if (Math.floor(plr.job() / 100 % 10) != 2) {
    npc.sendBackNext("You're no magician. I am not qualified to judge you. If you want to explore Zakum, you will need to find a master of your job class to be your guide.", true, false)
} else {
