...
if (plr.job() == 200 && plr.getLevel() >= 30 && plr.itemCount(4031009) >= 1 && plr.itemCount(4031013) < 30 && plr.itemCount(4031012) == 0) {
    ...
    npc.sendNext("Hmmm...it is definitely the letter from #bGrendel The Really Old#k...so you came all the way here to take the test and make the 2nd job advancement as the Magician. Alright, I'll explain the test to you. Don't sweat it too much, it's not that complicated.")
